...
<details>
  ...
  Reads `vm.runtime.sequencer.activeThread`.
</details>
...
<details>
  ...
  Reads from the `vm.runtime.threads` array.
</details>
...
## `(status [STATUSFORMAT] of [THREAD])` -> Number
...
<details>
  ...
  Reads `vm.runtime.sequencer.activeThreadIndex`.
</details>
