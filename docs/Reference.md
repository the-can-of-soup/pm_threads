...
| 3        | Waiting for frame    | `STATUS_YIELD_TICK`   | The thread is waiting for the next frame and will be skipped. Before a thread with this status would be skipped on the first tick of a frame, its status is set to `STATUS_RUNNING` so it is not skipped. |
